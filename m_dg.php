...
$page_title="Dasar Giat";
$modal_title="Dasar Giat";
...
<input type="hidden" name="cols" value="dg_id,dg_nam" />
<input type="hidden" name="tname" value="dasargiat" />
		
		  <div class="row">
			<div class="form-group col-md-12">
				<label>ID</label>
				<input type="text" id="dg_id" name="dg_id" placeholder="..." class="form-control">
			</div>
		  </div>
		  <div class="row">
			<div class="form-group col-md-12">
				<label>Nama</label>
				<input type="text" id="dg_nam" name="dg_nam" placeholder="..." class="form-control">
			</div>
		  </div>
		</form>
	  </div>
