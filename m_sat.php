...
$page_title="Satuan Wilayah";
$modal_title="Satuan Wilayah";
...
include "inc.db.php";
$conn=connect();
$wils=fetch_all(exec_qry($conn,"select wil_id,wil_nam from wilayah order by wil_nam"));
disconnect($conn);
?>
...
<input type="hidden" name="cols" value="sat_id,sat_nam,wil" />
<input type="hidden" name="tname" value="satwil" />
		
		  <div class="row">
			<div class="form-group col-md-12">
				<label>ID</label>
				<input type="text" id="sat_id" name="sat_id" placeholder="..." class="form-control">
			</div>
		  </div>
		  <div class="row">
			<div class="form-group col-md-12">
				<label>Nama</label>
				<input type="text" id="sat_nam" name="sat_nam" placeholder="..." class="form-control">
			</div>
		  </div>
		  <div class="row">
			<div class="form-group col-md-12">
				<label>Wilayah</label>
				<select id="wil" name="wil" class="form-control">
