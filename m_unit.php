...
<input type="hidden" name="cols" value="unit_id,unit_nam" />
<input type="hidden" name="tname" value="unit" />
		
		  <div class="row">
			<div class="form-group col-md-12">
				<label>ID</label>
				<input type="text" id="unit_id" name="unit_id" placeholder="..." class="form-control">
			</div>
		  </div>
		  <div class="row">
			<div class="form-group col-md-12">
				<label>Nama</label>
				<input type="text" id="unit_nam" name="unit_nam" placeholder="..." class="form-control">
			</div>
		  </div>
		</form>
	  </div>
...
$tname="unit";
$cols="unit_id,unit_nam,rowid";
$csrc="unit_id,unit_nam";
