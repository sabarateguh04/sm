...
<input type="hidden" name="cols" value="wil_id,wil_nam" />
<input type="hidden" name="tname" value="wilayah" />
		
		  <div class="row">
			<div class="form-group col-md-12">
				<label>ID</label>
				<input type="text" id="wil_id" name="wil_id" placeholder="..." class="form-control">
			</div>
		  </div>
		  <div class="row">
			<div class="form-group col-md-12">
				<label>Nama</label>
				<input type="text" id="wil_nam" name="wil_nam" placeholder="..." class="form-control">
			</div>
		  </div>
		</form>
	  </div>
